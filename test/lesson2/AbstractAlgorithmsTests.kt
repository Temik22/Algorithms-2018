...
Еще старушка не забыла
    ...
    fun baldaSearcher(baldaSearcher: (String, Set<String>) -> Set<String>) {
        ...
        assertEquals(setOf("ТРАВА", "КРАН", "АКВА", "НАРТЫ", "РАК", "РАНА", "РУКА", "ВАРКА", "ВАННА"),
                baldaSearcher("input/balda_in2.txt", setOf("ТРАВА", "КРАН", "АКВА", "МЦЖА", "НАРТЫ", "РАК", "РАНА", "РУКА", "ВАРКА", "ВАННА", "УРК")))
    }
}